...
export function founderIntakePrompt(): string {
  return [
    ...
    "",
    "Drax's commercial target is a founder who already has a product and wants to build an automatic, measurable organic traffic system.",
    ...
    "If the founder does not yet have a product, explain that this module is not the correct fit and document the qualification result without pretending the organic-growth system is ready.",
