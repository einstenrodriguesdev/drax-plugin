...
const required = [
  ...
  "plugins/drax/skills/drax/commands/drax-help.mjs",
  "plugins/drax/skills/drax/commands/drax-map.mjs",
  "plugins/drax/skills/drax-help/SKILL.md",
  "plugins/drax/skills/drax-map/SKILL.md",
  "plugins/drax/hooks/hooks.json",
  "plugins/drax/hooks/session-start.mjs",
  "templates/FOUNDER_BRAND_BRIEF.md",
  "templates/BOARD_MANDATE.md",
  "templates/VISION_AND_STRATEGY.md",
  "templates/POSITIONING_STATEMENT.md",
  "templates/MARKET_LOCALIZATION_STRATEGY.md",
  "templates/TECH_DECISION_RECORD.md",
  "templates/GTM_STRATEGY.md",
  "templates/CONTENT_STRATEGY.md",
  "templates/EDITORIAL_CALENDAR.md",
  "templates/CHANNEL_PLAN.md",
  "templates/AUTOMATION_RUNBOOK.md",
  "templates/RESPONSIBILITY_MATRIX.md",
  "templates/MEASUREMENT_FRAMEWORK.md",
